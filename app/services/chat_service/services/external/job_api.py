...
async def get_job_data(job_id: str, data_url: str = "http://backend-app:8000/job/api/v1"):
    ...
    try:
        ...
        raise HTTPException(status_code=504, detail="Job detail request timed out") from exc
        ...
        raise HTTPException(status_code=502, detail="Failed to fetch job detail") from exc
